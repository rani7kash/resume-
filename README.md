...
<body>
    ...
    <p><strong>BSc (Hons) Computer Science</strong><br>
        London Metropolitan University | Sept 2023 – June 2026 (Expected)</p>
    <ul>
        ...
        <li>Completed a <strong>Java bootcamp</strong>, placed 3rd in a competitive cohort.</li>
        <li>Designed and developed a <strong>children’s communication app</strong> to promote parent-child interaction.</li>
        <li>Created a <strong>car shop application</strong> using Java, BlueJ, and Processing, integrating backend databases for inventory management.</li>
    </ul>
    ...
    <h2>Projects</h2>
    <ul class="projects">
        <li><strong>Pikaboo: Interactive Parent-Child Communication App</strong><br>
            Designed and developed an interactive mobile app using Agile methodologies to foster parent-child engagement. Emphasized usability and functionality, delivering a seamless user experience with creative interactive tools.</li>
        <li><strong>Car Shop Application</strong><br>
            Built a comprehensive Java-based car shop application using BlueJ and Processing, with a focus on inventory management and smooth database integration through SQL. Implemented user-friendly interface and ensured smooth back-end operations.</li>
        <li><strong>Statistics Calculator</strong><br>
            Developed a Python-based calculator for statistical computations, refining programming and analytical skills.</li>
    </ul>
